...
Entry note for Juan Prim y Prats. Keep historical evidence, interpretation, and creative use separate.

## Linked Items

- People: [[Bazaine|Achille Bazaine]]
- Organizations: [[Mexican_Republic|Mexican Republic]], [[ODonnell_Government|O'Donnell Government]], [[Spanish_Expeditionary_Force|Spanish Expeditionary Force]], [[Spanish_Government|Spanish government]]
- Places:
- Events:
...
## Hamnett 1994 p.169 Intervention Notes

Hamnett p.169 treats Prim's appointment as commander of the [[Spanish_Expeditionary_Force|Spanish Expeditionary Force]] as evidence that the [[ODonnell_Government|O'Donnell government]] had moved away from a French regime-change project, and also groups Prim among those who warned that Mexico lacked a real monarchist party.

- Capture: [[CAP_HAMNETT_JUAREZ_0087]]
- Related Fact Cards: [[FACT_HAMNETT_JUAREZ_2012]], [[FACT_HAMNETT_JUAREZ_2016]]
- Related Timeline Entry: [[TIME_HAMNETT_JUAREZ_0687]]
- Related People: [[Napoleon_III]], [[Miguel_Miramon]], [[Bazaine]]
- Related Organizations: [[Spanish_Expeditionary_Force]], [[ODonnell_Government]], [[Spanish_Government]]
- Related Themes: [[Allied_Intervention_In_Mexico]], [[Mexican_Monarchist_Proposal]]
- Cautions: Confirm Prim's appointment date and the documentary basis for his warning.

## Historical Role

Evidence hub for **Juan Prim y Prats**. Treat this section as an index into linked evidence, not as a final historical summary.

- Key Fact Cards: [[FACT_HAMNETT_JUAREZ_2012|Prim's command appointment signaled Spanish retreat from regime change]], [[FACT_HAMNETT_JUAREZ_2016|Miramón, Prim, and Bazaine warned against assuming a real Mexican monarchist party]], [[FACT_MEXEMP_0291|英西側はフランスの特殊請求ではなく債務交渉を目的としていた]], [[FACT_MEXEMP_0292|Juan Prim y PratsはSalignyと対立しJuárezに同情的だった]], [[FACT_MEXEMP_0293|Primの妻の家族はメキシコ政府とつながりがあった]], [[FACT_MEXEMP_0301|英西の支援なしにフランス軍単独でMexico Cityへ進むのは危険だった]], [[FACT_MEXEMP_0336|Napoleon IIIは悪い報告の原因をPrimとJurienに帰した]], [[FACT_MEXEMP_0344|Napoleon IIIはPrimの対メキシコ政府交渉を否定的に見た]]
- Timeline Entries: [[TIME_HAMNETT_JUAREZ_0687|Juan Prim appointed commander of the Spanish Expeditionary Force]], [[TIME_MEXEMP_0064|1862年3月7日、Napoleon IIIがMaximilianへメキシコ情勢に関する書簡を書いた]]
...
## Hamnett 1994 pp.194-195 Relations with Spain Notes

Hamnett pp.194-195 says that after the Bourbon monarchy collapsed in Spain in 1868, Prim hoped to renew relations with Mexico, though restoration did not occur until June 1871.

- Capture: [[CAP_HAMNETT_JUAREZ_0100]]
- Related Fact Card: [[FACT_HAMNETT_JUAREZ_2357]]
- Related Timeline Entries: [[TIME_HAMNETT_JUAREZ_0812]], [[TIME_HAMNETT_JUAREZ_0813]]
- Related Places: [[Spain]], [[Mexico]]
