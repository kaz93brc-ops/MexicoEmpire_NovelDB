...
Entry note for Putla. Verify details in linked Fact Cards and Timeline Entries.

## Historical Role

Hamnett p.31 places Putla at the Oaxaca end of a wider sugar-cultivation zone extending from Cuernavaca and Cuautla.

## Creative Use

Use as a point where commercial agriculture, Oaxaca geography, and rural pressure can intersect.

## Open Questions

- Confirm the route and economic region Hamnett has in view, and identify local conflicts around Putla.
...
- Places:
- Events:
- Themes: [[Rural_Communities_And_Land_Claims|Rural Communities And Land Claims]], [[Rural_Rebellions|Rural Rebellions]]
