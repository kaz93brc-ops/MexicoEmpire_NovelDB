...
title: "BlasioはMaximilianの女性への関心に驚いたとされる"
statement: "José Luis Blasioは、Carlotaと結婚しているMaximilianが他の女性に関心を示すことに驚いたとされる。"
evidence_category: "primary_testimony"
confidence: "probable"
verification_needed: "yes"
claim: "José Luis Blasioは、Carlotaと結婚しているMaximilianが他の女性に関心を示すことに驚いたとされる。"
source_note: "39枚目スクリーンショットの該当叙述に基づく整理。"
japanese_note: "小説資料用に大意化したカード。原文長文は保存しない。"
creative_use: "側近の驚きを通じてMaximilianの評判を示す場面に使える。"
cautions: "Blasio証言の原典、回想時期、観察範囲を要確認。"
people:
  - "Maximilian"
  - "Carlota"
  - "José Luis Blasio"
...
# BlasioはMaximilianの女性への関心に驚いたとされる

## Claim

José Luis Blasioは、Carlotaと結婚しているMaximilianが他の女性に関心を示すことに驚いたとされる。
...
Blasio証言の原典、回想時期、観察範囲を要確認。

## Creative Use

側近の驚きを通じてMaximilianの評判を示す場面に使える。

## Links

- People: [[Maximilian]], [[Carlota]], [[Jose_Luis_Blasio|José Luis Blasio]]
- Events: [[Private_Life_Of_Maximilian_And_Carlota_In_Mexico|Private life of Maximilian and Carlota in Mexico]]
- Places: [[Mexico]]
- Organizations: [[Mexican_Imperial_Court|Mexican imperial court]]
- Themes: [[Court_Gossip|court gossip]], marriage, sexual reputation
- Related Fact Cards:
- Related Questions:
